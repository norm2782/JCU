...
(function(/*! Stitch !*/) {
  ...
  exports.HomeView = (function() {
    ...
    HomeView.prototype.render = function() {
      ...
      this.$(this.el).find('#rules-tree-div').append(app.views.rulesTree.render().el);
      this.$(this.el).find('#rules-list-div').append(app.views.rulesList.render().el);
      return this;
    };
    HomeView.prototype.addRule = function() {
      return alert("addRule");
    };
    HomeView.prototype.checkRules = function() {
      var callback;
      callback = function(data) {
        return alert("callback" + data);
      };
      return $.ajax({
        url: '/rules/check',
        type: 'POST',
